package com.example.user.sports.cycle.fragment;
...
import com.example.user.sports.cycle.model.User;
...
public class NearByExerciseFragment  extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_cycle_nearby_exercise, container, false);
        initView();
        return view;
    }

    private void initView() {
        mRecyclerView = (RecyclerView)view.findViewById(R.id.RecyclerView_cycle_nearby_exercise);
