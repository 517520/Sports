...
import com.example.user.sports.view.analysis.fragment.ValueFormatter.MyMarkerView;
...
public class KiloFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_analysis_kilo, container, false);
        initLineChart();
        return view;
    }

    private void initLineChart() {
        mLineChart = (LineChart)view.findViewById(R.id.lineChart_kilo);
