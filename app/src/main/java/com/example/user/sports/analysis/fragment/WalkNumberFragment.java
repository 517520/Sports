...
import com.example.user.sports.analysis.fragment.ValueFormatter.BarChartXAxisValueFormatter;
 ...
 */
public class WalkNumberFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_analysis_waik_number, container, false);
        initBarChart();
        return view;
    }

    private void initBarChart() {
        mChart = (BarChart)view.findViewById(R.id.barChart_walk_number);
    ...
    private void setData(int count, float range) {
        ...
        if (mChart.getData() != null &&
            ...
            data.setValueTextColor(0xFF249AE6);
            data.setValueTextSize(10f);
            data.setBarWidth(0.4f);
            mChart.setData(data);
        }
        set1.setColor(0xFF36BEBE);
    }
}
