...
public class ExitDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        view = LayoutInflater.from(context).inflate(R.layout.dialog_exit, null);
        setContentView(view);
    ...
    private void initView() {
        mStopTv = (TextView) view.findViewById(R.id.out_exit_tv);
        mContinueTv = (TextView) view.findViewById(R.id.record_exit_tv);
    ...
    private class clickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.out_exit_tv:
                    clickListenerInterface.doStop();
                    break;
                case R.id.record_exit_tv:
