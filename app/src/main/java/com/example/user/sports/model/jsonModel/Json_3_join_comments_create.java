...
public class Json_3_join_comments_create {
    ...
    public Json_3_join_comments_create(){ }


    public Json_3_join_comments_create(String phoneNumber,int activity_id,int comment_otherpeo_id,String comment_content){
