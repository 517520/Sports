...
/**
 * 运动圈信息，获取我发布的某个活动下的所有评论
 */
public class Json_3_release_comments_all {
    ...
    public Json_3_release_comments_all(){ }

    public Json_3_release_comments_all(String phoneNumber,int activity_id,int comment_otherpeo_id){
